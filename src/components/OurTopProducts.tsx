...
export default function FAQSection() {
  ...
  return (
    <section className="relative w-full bg-[#fafafa] py-24 px-6 md:px-12 overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-6xl mx-auto text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-base md:text-lg">
            Find quick answers to common questions about our pickup, cleaning,
      ...
      {/* Background Glow (behind + no clicks) */}
      <div className="pointer-events-none absolute -top-20 left-0 w-96 h-96 bg-[#003636]/10 rounded-full blur-3xl opacity-60 -z-10" />
      <div className="pointer-events-none absolute bottom-0 right-0 w-[500px] h-[500px] bg-[#003636]/15 rounded-full blur-3xl opacity-40 -z-10" />
    </section>
  );
}
